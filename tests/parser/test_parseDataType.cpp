...
#include "PropertiesModels.h"    // Contains the Types enum, DataType struct, and TypeQualifier definitions.
#include <string_view>
...
TEST(ParseDataTypeTest, RecognizesVoid) {
    ...
    EXPECT_EQ(dt.type, PropertiesModels::Types::VOID);
...
TEST(ParseDataTypeTest, RecognizesInt) {
    ...
    EXPECT_EQ(dt.type, PropertiesModels::Types::INT);
    EXPECT_FALSE(dt.customType.has_value());
}
...
TEST(ParseDataTypeTest, RecognizesUint) {
    ...
    EXPECT_EQ(dt.type, PropertiesModels::Types::UINT);
    EXPECT_FALSE(dt.customType.has_value());
}
...
TEST(ParseDataTypeTest, RecognizesLongLong) {
    ...
    EXPECT_EQ(dt.type, PropertiesModels::Types::LONGLONG);
}
...
TEST(ParseDataTypeTest, CustomTypeReturnsCustom) {
    ...
    EXPECT_EQ(dt.type, PropertiesModels::Types::CUSTOM);
...
TEST(ParseDataTypeTest, RecognizesConstQualifier) {
    ...
    EXPECT_EQ(dt.type, PropertiesModels::Types::INT);
    EXPECT_TRUE(PropertiesModels::hasQualifier(dt.qualifiers, PropertiesModels::TypeQualifier::CONST));
    EXPECT_FALSE(PropertiesModels::hasQualifier(dt.qualifiers, PropertiesModels::TypeQualifier::VOLATILE));
}
...
TEST(ParseDataTypeTest, RecognizesVolatileQualifier) {
    ...
    EXPECT_EQ(dt.type, PropertiesModels::Types::FLOAT);
    EXPECT_TRUE(PropertiesModels::hasQualifier(dt.qualifiers, PropertiesModels::TypeQualifier::VOLATILE));
    EXPECT_FALSE(PropertiesModels::hasQualifier(dt.qualifiers, PropertiesModels::TypeQualifier::CONST));
}
